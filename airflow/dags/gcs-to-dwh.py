    ...
    create_root_messages_table = BigQueryUpsertTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [
                    f"gs://{BUCKET}/clean/messages/{CHANNEL_NAME}*_rootmessages.parquet"
                ],
            },
        },
    )
    ...
    create_thread_replies_table = BigQueryUpsertTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                "sourceFormat": "PARQUET",
                "sourceUris": [
                    f"gs://{BUCKET}/clean/messages/{CHANNEL_NAME}*_threadreplies.parquet"
                ],
            },
        },
    )
    ...
    create_reactions_table = BigQueryUpsertTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                "sourceFormat": "PARQUET",
                "sourceUris": [
                    f"gs://{BUCKET}/clean/messages/{CHANNEL_NAME}*_reactions.parquet"
                ],
            },
        },
    )
